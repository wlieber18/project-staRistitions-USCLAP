...
quantile(bll_data$imprisonment_rt, 0.99, na.rm = TRUE)
...
bll_data |>
  ...
  labs(
    title = "Distribution of Imprisionment Rates in CA",
...
bll_data |>
  ...
  labs(
    title = "Distribution of Children Under 6 with High Blood Lead Levels in CA",
    subtitle = "by Census Tract",
    x = "Children under 6 with a BLL of 3.5 µg/dL or greater (%)",
    y = "Count",
    caption = "Capturing ~99% of data"
  )
```
