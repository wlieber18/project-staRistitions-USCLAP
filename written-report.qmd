...
bll_data %>% 
  ...
  geom_smooth(method = "lm", se = FALSE, linewidth = 0.6, color = "steelblue3", linetype = 2) +
...
**Imprisonment vs Population Aged 15-29 (Figure 8):** Imprisonment rate and percentage of population aged 15-29 in the census tract has a generally positive correlation. This isn't surprising as it's generally understood that one's likelihood to engage in illegal activities is higher as an adolescent.
